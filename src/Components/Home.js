  ...
  return (
    <div className="home">
      ...
      <div className="home__info" style={{ color: "white" }}>
        ...
        <p>
          Registration Ends On <span>28th February</span>
        </p>
        <div>
        <p className="sp">
          Paper Submisssion Ends On <span>1st March</span> 
        </p>
        </div>
       
        <Countdown className="countdown" date={(1676633222001 + 880160000 +86400000 )}>
