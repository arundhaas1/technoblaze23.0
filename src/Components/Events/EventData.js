  ...
  return (
    <div className="eventdatas">
      ...
      <div className="event__nontecdata">
        ...
        <Card p={"Avirally transmitted image embellished with text, usually sharing pointed commentary"} name={"Meme Creation"} url={"assets/11.jpg"} />
        <Card p={"Photography is the art, application, and practice of creating durable images by recording light"} name={"Photography"} url={"assets/12.jpg"} />
